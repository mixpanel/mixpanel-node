...
const customBetween = (op, key, lo, hi) => ({
  and: [{ [op]: [varNode(key), ">=", lo] }, { [op]: [varNode(key), "<=", hi] }],
});
...
describe("semver_compare operator", () => {
  it.each([
    ...
    [
      ...
      semverRule("app_version", ">", "1.9.0"),
      { app_version: "1.10.0" },
      true,
    ],
    [
      "prerelease precedes release",
      semverRule("app_version", "<", "1.0.0"),
    ...
    [
      ...
      semverRule("app_version", "<", "1.0.0-beta"),
      { app_version: "1.0.0-alpha" },
      true,
    ],
    [
      "prerelease beta before rc1",
      semverRule("app_version", "<", "1.0.0-rc1"),
      { app_version: "1.0.0-beta" },
      true,
    ],
    [
      "prerelease rc1 before rc2",
      semverRule("app_version", "<", "1.0.0-rc2"),
      { app_version: "1.0.0-rc1" },
      true,
    ],
    [
      "more prerelease fields wins",
      semverRule("app_version", "<", "1.0.0-alpha.1"),
      { app_version: "1.0.0-alpha" },
      true,
    ],
    [
      "numeric identifier below alphanumeric",
      semverRule("app_version", "<", "1.0.0-alpha.beta"),
    ...
    [
      ...
      semverRule("app_version", ">", "1.0.0-rc.1"),
      { app_version: "1.0.0-rc1" },
      true,
    ],
    [
      "core version dominates prerelease",
      semverRule("app_version", ">", "1.9.9"),
    ...
    [
      ...
      semverRule("app_version", ">", "1.0.0-alpha"),
      { app_version: "1.0.0" },
      true,
    ],
    [
    ...
    [
      ...
      semverRule("app_version", ">", "0.9.9"),
      { app_version: "1.0.0-alpha" },
      true,
    ],
    [
      "prerelease below the next patch",
      semverRule("app_version", "<", "1.0.1"),
      { app_version: "1.0.0-rc1" },
      true,
    ],
    ...
    [
      ...
      semverRule("app_version", "<", "1.0.0-10"),
      { app_version: "1.0.0-2" },
      true,
    ],
    [
    ...
    [
      ...
      semverRule("app_version", "=", "1.0.0+build2"),
    ...
    [
      ...
      semverRule("app_version", "<", "1.0.1+build1"),
      { app_version: "1.0.0+build9" },
      true,
    ],
    [
      "build metadata does not block reverse ordering",
      semverRule("app_version", ">", "1.0.0+build9"),
    ...
    [
      "between, inside",
      customBetween("semver_compare", "app_version", "1.2.3", "2.0.0"),
      { app_version: "1.5.0" },
      true,
    ],
    [
    ...
    [
      ...
      customBetween("semver_compare", "app_version", "1.2.3", "1.2.3"),
      { app_version: "1.2.3" },
      true,
    ],
    ...
    [
      "missing operand, no match",
      { semver_compare: [varNode("app_version"), "="] },
      { app_version: "1.2.3" },
      false,
    ],
...
describe("datetime_compare operator", () => {
  it.each([
    ...
    [
      "between, inside",
      datetimeBetween("signup", JAN1_MS, DEC31_MS),
    ...
    [
      "leap day",
      datetimeRule("signup", "=", LEAP_DAY_MS),
    ...
    [
      ...
      datetimeRule("signup", "=", JUL16_INDIA_MS),
    ...
    [
      "negative offset",
      datetimeRule("signup", "=", JUL16_PACIFIC_MS),
    ...
    [
      "missing operand, no match",
      { datetime_compare: [varNode("signup"), "="] },
      { signup: "2026-07-16T00:00:00Z" },
      false,
    ],
  ])("%s", (_name, rule, data, want) => {
