...
export function classify_user_agent(userAgent: string | null | undefined): AiBotClassification;
export function create_classifier(options: { additional_bots?: AiBotEntry[] }): (userAgent: string) => AiBotClassification;
