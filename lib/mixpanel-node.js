...
const {merge_modifiers, _set, _delete_profile, _unset, _union, _remove} = require('./profile_helpers');
...
var create_client = function(token, config) {
    ...
    */
    metrics.set_config = (new_config) => {
        metrics.config = create_config(new_config);
        /**
         ...
         */
        metrics.send_request = create_send_request_func(metrics.config);

        metrics.groups = create_group_funcs({
            token: metrics.token,
            config: metrics.config,
            send_request: metrics.send_request,
        });
    };
    ...
    metrics.people = {
        ...
        */
        set_once: function(distinct_id, prop, to, modifiers, callback) {
            ...
            _set(prop, to, modifiers, callback, {identifiers, set_once: true, token: metrics.token, endpoint: ENGAGE_ENDPOINT, send_request: metrics.send_request, config: metrics.config});
        },
        ...
        */
        set: function(distinct_id, prop, to, modifiers, callback) {
            const identifiers = {$distinct_id: distinct_id};
            _set(prop, to, modifiers, callback, {identifiers, token: metrics.token, endpoint: ENGAGE_ENDPOINT, send_request: metrics.send_request, config: metrics.config});
        },
        ...
        */
        delete_user: function(distinct_id, modifiers, callback) {
            const identifiers = {$distinct_id: distinct_id};
            _delete_profile({identifiers, modifiers, callback, endpoint: ENGAGE_ENDPOINT, token: metrics.token, send_request: metrics.send_request, config: metrics.config});
        },
        ...
        */
        ...
        union: function(distinct_id, data, modifiers, callback) {
            const identifiers = {$distinct_id: distinct_id};
            _union({identifiers, data, modifiers, callback, endpoint: ENGAGE_ENDPOINT, token: metrics.token, send_request: metrics.send_request, config: metrics.config});
        },
        ...
        unset: function(distinct_id, prop, modifiers, callback) {
            const identifiers = {$distinct_id: distinct_id};
            _unset({identifiers, prop, modifiers, callback, endpoint: ENGAGE_ENDPOINT, token: metrics.token, send_request: metrics.send_request, config: metrics.config});
        }
    };
