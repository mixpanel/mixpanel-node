...
var create_client = function(token, config) {
    ...
    */
    ...
    metrics.track_or_import = function(endpoint, event, properties, callback) {
    ...
    /**
        ...
        callback:function(err:Error)    callback is called when the request is
                                        finished or an error occurs
    */
    metrics.track = metrics.track_or_import.bind(null, '/track');
    ...
    */
    metrics.import = function(event, time, properties, callback) {
        ...
        metrics.track_or_import('/import', event, properties, callback);
    };
