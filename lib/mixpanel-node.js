...
const {async_all, ensure_timestamp, create_config} = require('./utils');
...
var create_client = function(token, config) {
    ...
    */
    metrics.set_config = (new_config) => {
        ...
        const profile_helpers = create_profile_helpers({token: metrics.token, config, send_request: metrics.send_request});
        Object.assign(metrics, {config, _helpers: profile_helpers});
    };
