...
var create_client = function(token, config) {
    ...
    metrics.send_request = function(options, callback) {
        ...
        const make_request = pb.make(function makeRequest(cb) {
    ...
    metrics.send_event_request = function(endpoint, event, properties, callback) {
        ...
        return metrics.send_request({ method: "GET", endpoint: endpoint, data: data }, callback);
    };
    ...
    metrics.track = function(event, properties, callback) {
        ...
        return metrics.send_event_request("/track", event, properties, callback);
    };
    ...
    */
    metrics.import = function(event, time, properties, callback) {
        ...
        return metrics.send_event_request("/import", event, properties, callback);
    };
    ...
    */
    metrics.alias = function(distinct_id, alias, callback) {
        ...
        return metrics.track('$create_alias', properties, callback);
    };
