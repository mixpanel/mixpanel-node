...
var create_client = function(token, config) {
    ...
    */
    metrics.track = function(event, properties, callback) {
        var import_time_limit = parse_time(new Date(Date.now() - 1000 * 60 * 60 * 24 * 5));
        ...
        // if properties.time more than 5 days old, use import endpoint
        var endpoint = (typeof(properties.time) === 'number' && properties.time < import_time_limit) ? '/import' : '/track';
