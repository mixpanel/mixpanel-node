...
exports.ProfileHelpers = (Base = Object) => class extends Base {
    ...
    _set(prop, to, modifiers, callback, {identifiers, set_once = false, endpoint}) {
        let $set = {};
        ...
        this.mixpanel.send_request({ method: "GET", endpoint, data }, callback);
    }

    _delete_profile({identifiers, modifiers, callback, endpoint}){
        let data = {
            '$delete': '',
            '$token': this.token,
            ...identifiers,
    ...
    _remove({identifiers, data, modifiers, callback, endpoint}) {
        let $remove = {};
    ...
    _union({identifiers, data, modifiers, callback, endpoint}) {
        let $union = {};
    ...
    _unset({identifiers, prop, modifiers, callback, endpoint}){
        let $unset = [];
