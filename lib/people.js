...
class MixpanelPeople extends ProfileHelpers() {
    ...
    */
    set_once(distinct_id, prop, to, modifiers, callback) {
        ...
        return this._set(prop, to, modifiers, callback, {identifiers, set_once: true});
    }
    ...
    */
    set(distinct_id, prop, to, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        return this._set(prop, to, modifiers, callback, {identifiers});
    }
    ...
    */
    increment(distinct_id, prop, by, modifiers, callback) {
        ...
        return this.mixpanel.send_request({ method: "GET", endpoint: "/engage", data: data }, callback);
    }
    ...
    */
    delete_user(distinct_id, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        return this._delete_profile({identifiers, modifiers, callback});
    }
    ...
    */
    remove(distinct_id, data, modifiers, callback) {
        const identifiers = {'$distinct_id': distinct_id};
        return this._remove({identifiers, data, modifiers, callback})
    }
    ...
    */
    union(distinct_id, data, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        return this._union({identifiers, data, modifiers, callback});
    }
    ...
    */
    unset(distinct_id, prop, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        return this._unset({identifiers, prop, modifiers, callback});
    }
};
