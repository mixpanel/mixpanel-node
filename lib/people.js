...
class MixpanelPeople extends ProfileHelpers() {
    ...
    */
    set_once(distinct_id, prop, to, modifiers, callback) {
        ...
        this._set(prop, to, modifiers, callback, {identifiers, set_once: true, endpoint: ENGAGE_ENDPOINT});
    }
    ...
    */
    set(distinct_id, prop, to, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        this._set(prop, to, modifiers, callback, {identifiers, endpoint: ENGAGE_ENDPOINT});
    }
    ...
    */
    delete_user(distinct_id, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        this._delete_profile({identifiers, modifiers, callback, endpoint: ENGAGE_ENDPOINT});
    }
    ...
    */
    remove(distinct_id, data, modifiers, callback) {
        const identifiers = {'$distinct_id': distinct_id};
        this._remove({identifiers, data, modifiers, callback, endpoint: ENGAGE_ENDPOINT})
    }
    ...
    */
    union(distinct_id, data, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        this._union({identifiers, data, modifiers, callback, endpoint: ENGAGE_ENDPOINT});
    }
    ...
    */
    unset(distinct_id, prop, modifiers, callback) {
        const identifiers = {$distinct_id: distinct_id};
        this._unset({identifiers, prop, modifiers, callback, endpoint: ENGAGE_ENDPOINT});
    }
};
