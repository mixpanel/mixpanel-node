...
class MixpanelGroups {
    ...
    */
    set_once(group_key, group_id, prop, to, modifiers, callback) {
        ...
        this.mixpanel._helpers._set(prop, to, modifiers, callback, {identifiers, set_once: true, endpoint: GROUPS_ENDPOINT});
    }
    ...
    */
    set(group_key, group_id, prop, to, modifiers, callback) {
        const identifiers = {$group_key: group_key, $group_id: group_id};
        this.mixpanel._helpers._set(prop, to, modifiers, callback, {identifiers, endpoint: GROUPS_ENDPOINT});
    }
    ...
    delete_group(group_key, group_id, modifiers, callback) {
        const identifiers = {$group_key: group_key, $group_id: group_id};
        this.mixpanel._helpers._delete_profile({identifiers, modifiers, callback, endpoint: GROUPS_ENDPOINT});
    }
    ...
    remove(group_key, group_id, data, modifiers, callback) {
        const identifiers = {$group_key: group_key, $group_id: group_id};
        this.mixpanel._helpers._remove({identifiers, data, modifiers, callback, endpoint: GROUPS_ENDPOINT});
    }
    ...
    union(group_key, group_id, data, modifiers, callback) {
        const identifiers = {$group_key: group_key, $group_id: group_id};
        this.mixpanel._helpers._union({identifiers, data, modifiers, callback, endpoint: GROUPS_ENDPOINT})
    }
    ...
    unset(group_key, group_id, prop, modifiers, callback) {
        const identifiers = {$group_key: group_key, $group_id: group_id};
        this.mixpanel._helpers._unset({identifiers, prop, modifiers, callback, endpoint: GROUPS_ENDPOINT})
    }
}
