...
exports.create_group_funcs = function({profile_helpers}){
    const GROUPS_ENDPOINT = "/groups";
    const {_set, _delete_profile, _remove, _union, _unset} = profile_helpers;
    return {
        ...
        set_once: function(group_key, group_id, prop, to, modifiers, callback) {
            ...
            _set(prop, to, modifiers, callback, {identifiers, set_once: true, endpoint: GROUPS_ENDPOINT});
        },
        ...
        set: function(group_key, group_id, prop, to, modifiers, callback) {
            const identifiers = {$group_key: group_key, $group_id: group_id};
            _set(prop, to, modifiers, callback, {identifiers, endpoint: GROUPS_ENDPOINT});
        },
        ...
        delete_group: function(group_key, group_id, modifiers, callback) {
            const identifiers = {$group_key: group_key, $group_id: group_id};
            _delete_profile({identifiers, modifiers, callback, endpoint: GROUPS_ENDPOINT});
        },
        ...
        remove: function(group_key, group_id, data, modifiers, callback) {
            const identifiers = {$group_key: group_key, $group_id: group_id};
            _remove({identifiers, data, modifiers, callback, endpoint: GROUPS_ENDPOINT});
        },
        ...
        union: function(group_key, group_id, data, modifiers, callback) {
            const identifiers = {$group_key: group_key, $group_id: group_id};
            _union({identifiers, data, modifiers, callback, endpoint: GROUPS_ENDPOINT})
        },
        ...
        unset: function(group_key, group_id, prop, modifiers, callback) {
            const identifiers = {$group_key: group_key, $group_id: group_id};
            _unset({identifiers, prop, modifiers, callback, endpoint: GROUPS_ENDPOINT})
        }
    };
}
