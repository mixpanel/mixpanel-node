...
describe("RemoteFeatureFlagProvider", () => {
  ...
  beforeEach(() => {
    ...
    provider = new RemoteFeatureFlagsProvider(
      TEST_TOKEN,
      config,
      mockTracker,
      mockLogger,
  ...
  describe("getVariantValue", () => {
    it("should return variant value when flag exists", async () => {
      ...
      const result = await provider.getVariantValue(
        "test-flag",
        "default",
        TEST_CONTEXT,
      );
    ...
    it("should NOT track exposure event when reportExposure is false", async () => {
      ...
      await provider.getVariantValue(
        "test-flag",
        "default",
        TEST_CONTEXT,
        false,
    ...
    it("should handle different variant value types", async () => {
      ...
      let result = await provider.getVariantValue(
        "string-flag",
        "default",
        TEST_CONTEXT,
      );
