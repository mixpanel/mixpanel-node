...
describe("send_request", () => {
  ...
  it("sends correct data on POST", () => {
    const endpoint = "/track",
      ...
      expected_http_request_body =
        "data=eyJldmVudCI6InRlc3QiLCJwcm9wZXJ0aWVzIjp7ImtleTEiOiJ2YWwxIiwidG9rZW4iOiJ0b2tlbiIsInRpbWUiOjEzNDY4NzY2MjF9fQ==";
  ...
  it("handles mixpanel errors", () => {
    mixpanel.send_request(
      { endpoint: "/track", data: { event: "test" } },
      function (e) {
